...
For Teams/Enterprise commands, set the task's `License Key` input (passed to flyway as `-licenseKey`). See [Redgate's licensing docs](https://documentation.red-gate.com/fd/licensing-164167730.html) to obtain a key. Community-tier commands need no license key.
